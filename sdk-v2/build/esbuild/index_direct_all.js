...
var require_query_param_serializer = __commonJS((exports2, module2) => {
  var util = require_util();
...
var require_rest_json = __commonJS((exports2, module2) => {
  var util = require_util();
...
var require_rest_xml = __commonJS((exports2, module2) => {
  var AWS2 = require_core();
  var util = require_util();
  var Rest = require_rest();
  function populateBody(req) {
...
var require_escape_attribute = __commonJS((exports2, module2) => {
...
var require_xml_node = __commonJS((exports2, module2) => {
...
var require_escape_element = __commonJS((exports2, module2) => {
...
var require_xml_text = __commonJS((exports2, module2) => {
...
var require_builder2 = __commonJS((exports2, module2) => {
  var util = require_util();
...
var require_paginator = __commonJS((exports2, module2) => {
...
var require_resource_waiter = __commonJS((exports2, module2) => {
  var util = require_util();
  var property = util.property;
...
var require_api_loader = __commonJS((exports2, module2) => {
...
var require_endpoint_cache = __commonJS((exports2) => {
  "use strict";
  Object.defineProperty(exports2, "__esModule", {value: true});
...
var require_sequential_executor = __commonJS((exports2, module2) => {
  var AWS2 = require_core();
...
var require_region_config_data = __commonJS((exports2, module2) => {
  module2.exports = {
    rules: {
      "*/*": {
...
var require_region_config = __commonJS((exports2, module2) => {
  var util = require_util();
...
var require_discover_endpoint = __commonJS((exports2, module2) => {
  var AWS2 = require_core();
  var util = require_util();
...
var require_state_machine = __commonJS((exports2, module2) => {
...
var require_v2 = __commonJS((exports2, module2) => {
  var AWS2 = require_core();
  var inherit = AWS2.util.inherit;
...
var require_v3 = __commonJS((exports2, module2) => {
  var AWS2 = require_core();
  var inherit = AWS2.util.inherit;
...
var require_v3https = __commonJS((exports2, module2) => {
  var AWS2 = require_core();
  var inherit = AWS2.util.inherit;
  require_v3();
...
var require_v4_credentials = __commonJS((exports2, module2) => {
  var AWS2 = require_core();
  var cachedSecret = {};
  var cacheQueue = [];
...
var require_s3 = __commonJS((exports2, module2) => {
  var AWS2 = require_core();
  var inherit = AWS2.util.inherit;
...
var require_presign = __commonJS((exports2, module2) => {
  var AWS2 = require_core();
  var inherit = AWS2.util.inherit;
  var expiresHeader = "presigned-expires";
...
var require_event_message_chunker_stream = __commonJS((exports2, module2) => {
...
var require_split_message = __commonJS((exports2, module2) => {
  var util = require_core().util;
  var toBuffer = util.buffer.toBuffer;
...
var require_parse_message = __commonJS((exports2, module2) => {
...
var require_parse_event = __commonJS((exports2, module2) => {
...
var require_event_message_unmarshaller_stream = __commonJS((exports2, module2) => {
  var Transform = require("stream").Transform;
...
var require_streaming_create_event_stream = __commonJS((exports2, module2) => {
...
var require_event_message_chunker = __commonJS((exports2, module2) => {
...
var require_buffered_create_event_stream = __commonJS((exports2, module2) => {
...
var require_nodeClock = __commonJS((exports2, module2) => {
  module2.exports = {
    now: function now() {
...
var require_ini_loader = __commonJS((exports2, module2) => {
  var AWS2 = require_core();
  var os = require("os");
...
var require_shared_ini = __commonJS((exports2, module2) => {
...
var require_config_regional_endpoint = __commonJS((exports2, module2) => {
  var AWS2 = require_core();
...
var require_sts_2011_06_15_min = __commonJS((exports2, module2) => {
  module2.exports = {
    version: "2.0",
    metadata: {
...
var require_sts_2011_06_15_paginators = __commonJS((exports2, module2) => {
  module2.exports = {
    pagination: {}
  };
});
...
var require_sts2 = __commonJS((exports2, module2) => {
  require_node_loader();
  var AWS2 = require_core();
...
var require_cognito_identity_2014_06_30_min = __commonJS((exports2, module2) => {
  module2.exports = {
    version: "2.0",
    metadata: {
...
var require_cognito_identity_2014_06_30_paginators = __commonJS((exports2, module2) => {
  module2.exports = {
    pagination: {
      ListIdentityPools: {
...
var require_cognitoidentity = __commonJS((exports2, module2) => {
  require_node_loader();
  var AWS2 = require_core();
  var Service = AWS2.Service;
  var apiLoader = AWS2.apiLoader;
...
var require_builder3 = __commonJS((exports2) => {
  (function() {
    "use strict";
...
var require_node_parser = __commonJS((exports2, module2) => {
  var AWS2 = require_core();
  var util = AWS2.util;
...
var require_metadata_service = __commonJS((exports2, module2) => {
  var AWS2 = require_core();
  require_http();
  var inherit = AWS2.util.inherit;
  AWS2.MetadataService = inherit({
    ...
    request: function request(path, options, callback) {
      ...
      path = path || "/";
      var httpRequest = new AWS2.HttpRequest("http://" + this.host + path);
    ...
    load: function load(callback) {
      ...
      self.metadataService.loadCredentials(function(err, creds) {
        if (!err) {
          ...
          if (expireTime < currentTime) {
            err = AWS2.util.error(new Error("EC2 Instance Metadata Serivce provided expired credentials"), {code: "EC2MetadataCredentialsProviderFailure"});
          } else {
            self.expired = false;
            self.metadata = creds;
...
var require_node_loader = __commonJS((exports2, module2) => {
  var util = require_util();
...
var require_numberValue = __commonJS((exports2, module2) => {
  var util = require_core().util;
...
var require_translator = __commonJS((exports2, module2) => {
  var util = require_core().util;
...
var require_document_client = __commonJS((exports2, module2) => {
  var AWS2 = require_core();
...
var require_dynamodb_2011_12_05_min = __commonJS((exports2, module2) => {
  module2.exports = {
    version: "2.0",
    metadata: {
...
var require_dynamodb_2011_12_05_paginators = __commonJS((exports2, module2) => {
  module2.exports = {
    pagination: {
      BatchGetItem: {
...
var require_dynamodb_2011_12_05_waiters2 = __commonJS((exports2, module2) => {
  module2.exports = {
    version: 2,
    waiters: {
      TableExists: {
...
var require_dynamodb_2012_08_10_min = __commonJS((exports2, module2) => {
  module2.exports = {
    version: "2.0",
    metadata: {
...
var require_dynamodb_2012_08_10_paginators = __commonJS((exports2, module2) => {
  module2.exports = {
    pagination: {
      BatchGetItem: {
        input_token: "RequestItems",
...
var require_dynamodb_2012_08_10_waiters2 = __commonJS((exports2, module2) => {
  module2.exports = {
    version: 2,
    waiters: {
      TableExists: {
...
var require_dynamodb2 = __commonJS((exports2, module2) => {
  require_node_loader();
  var AWS2 = require_core();
  var Service = AWS2.Service;
  var apiLoader = AWS2.apiLoader;
