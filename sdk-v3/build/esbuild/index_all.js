...
var require_DynamoDB = __commonJS((exports2) => {
  ...
  var DynamoDB2 = class extends DynamoDBClient_1.DynamoDBClient {
...
var dynamodb = new import_client_dynamodb.DynamoDB({apiVersion: "2012-08-10"});
async function demo() {
