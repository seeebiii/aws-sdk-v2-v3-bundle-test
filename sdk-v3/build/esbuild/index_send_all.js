...
var require_models_0 = __commonJS((exports2) => {
  ...
  var ScanInput;
  (function(ScanInput2) {
    ScanInput2.filterSensitiveLog = (obj) => ({
      ...obj,
      ...obj.ScanFilter && {
  ...
  })(ScanInput = exports2.ScanInput || (exports2.ScanInput = {}));
  ...
  (function(QueryInput2) {
    QueryInput2.filterSensitiveLog = (obj) => ({
      ...obj,
      ...obj.KeyConditions && {
  ...
  })(QueryInput = exports2.QueryInput || (exports2.QueryInput = {}));
...
var require_GetItemCommand = __commonJS((exports2) => {
  ...
  var middleware_serde_1 = require_cjs34();
  var smithy_client_1 = require_cjs33();
  var GetItemCommand2 = class extends smithy_client_1.Command {
    constructor(input) {
      super();
      this.input = input;
    }
  ...
  exports2.GetItemCommand = GetItemCommand2;
});
...
var require_UpdateItemCommand = __commonJS((exports2) => {
  ...
  var middleware_serde_1 = require_cjs34();
  var smithy_client_1 = require_cjs33();
  var UpdateItemCommand2 = class extends smithy_client_1.Command {
    constructor(input) {
      super();
      this.input = input;
    }
...
var require_poller = __commonJS((exports2) => {
  ...
  var runPolling = async ({minDelay, maxDelay, maxWaitTime, abortController, client: client2}, input, acceptorChecks) => {
    var _a;
    const {state} = await acceptorChecks(client2, input);
    ...
    while (true) {
      ...
      const {state: state2} = await acceptorChecks(client2, input);
...
var require_waitForTableExists = __commonJS((exports2) => {
  ...
  var checkState = async (client2, input) => {
    try {
      let result = await client2.send(new DescribeTableCommand_1.DescribeTableCommand(input));
      try {
...
// index_send.js
var import_client_dynamodb = __toModule(require_cjs36());
var client = new import_client_dynamodb.DynamoDBClient({apiVersion: "2012-08-10"});
async function demo() {
  await client.send(new import_client_dynamodb.GetItemCommand());
  await client.send(new import_client_dynamodb.UpdateItemCommand());
}
demo().then(() => console.log("done")).catch(() => process.exit(1));
